...
from connect4_expectimax import create_board, drop_piece, is_valid_location, get_next_open_row, winning_move, get_ai_move

class ConnectFourApp:
    def __init__(self, master):
        self.master = master
        self.master.title("Connect Four - Expectimax")
    ...
    def create_widgets(self):
        ...
        for row in range(6):
            row_cells = []
            for col in range(7):
                cell = tk.Button(self.master, text="", width=12, height=6,
